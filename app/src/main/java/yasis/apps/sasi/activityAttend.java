...
public class activityAttend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //startActivity(new Intent(activityAttend.this,activityVerification.class));
        //Register the UI IDs
...
//            startActivity(new Intent(MainActivity.this,Login.class));
    ...
    public void getLesson(){
       progressBar.setVisibility(View.VISIBLE);
        ...
        final String dayOfWeek = "Wednesday";//days[dayOfWeekInt-1];
        ...
        databaseReference
            ...
            public void onComplete(@Nullable DatabaseError databaseError, @NonNull DatabaseReference databaseReference) {
                ...
                if(databaseError!=null){
                    Toast.makeText(activityAttend.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
             });
